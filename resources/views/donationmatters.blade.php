...
<div class="container">
    <div class="donateme">
        ...
        <p class="text-black fw-bold p-4" data-aos="fade-up">
...
<div class="joinus">
    <div class="giver1" data-aos="fade-up">
      <img src="{{ asset("images/bg4.jpg") }}" alt="make a difference" class="giverpicss">
      <p class="mt-3 text-center giverpara" data-aos="zoom-in">
        <strong class="donationwrite">GLOBAL REACH:</strong> We support diverse causes across the globe, touching lives in every corner of the world.
      </p>

       {{-- modal --}}
            <div data-aos="zoom-in">
              <!-- Button trigger modal -->
              <button type="button" class="btn giverbuttns rounded-4" data-bs-toggle="modal" data-bs-target="#staticBackdrop">
                ...
                <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                  <div class="modal-content">
                    ...
                    <form action="{{ route('send.message') }}" class="modalform" method="POST">
                        ...
                        <label for="form-label" class="modalformlabel"> Phone </label>
                        <input type="tel" name="telphone" class="form-control shadow rounded-4 mb-3 modalinput">

                        <label for="form-label" class="modalformlabel"> Address </label>
                        <textarea name="address" required id="" cols="30" rows="2" class="form-control shadow rounded-4 mb-3 modalinput"></textarea>

                        <label for="form-label" class="modalformlabel">Message</label>
                        <textarea name="donatemessage" id="" cols="30" rows="5" class="form-control shadow rounded-4 mb-3 modalinput"></textarea>
    ...
    <div class=" giver1" data-aos="fade-up">
      <img src="{{ asset("images/bg1.jpg") }}" alt="make a difference" class="giverpicss">
      <p class="mt-3 text-center giverpara" data-aos="zoom-in">
        <strong class="donationwrite">COMMUNITY IMPACT:</strong> Your donation strengthens communities, fosters education, provides healthcare, and empowers the underprivileged.
      </p>
             {{-- modal --}}
            <div data-aos="zoom-in">
              <!-- Button trigger modal -->
    ...
    <div class=" giver1" data-aos="fade-up">
      <img src="{{ asset("images/bg9.jpg") }}" alt="make a difference" class="giverpicss">
      <p class="mt-3 text-center giverpara" data-aos="zoom-in">
        <strong class="donationwrite">SUSTAINABLE CHANGE:</strong> We invest in sustainable projects, ensuring your donation creates a lasting impact for generations to come.
      </p>
...
<div class="getamails1 ">
    <div class="wantmorequick text-white" data-aos="zoom-in"> Quick Enquiry </div>
    <div class="getamail22">
      <div class="wantinfo" data-aos="fade-up">want more information ?</div>
      <div>
        <div class="wantinfodivs" data-aos="fade-up">
