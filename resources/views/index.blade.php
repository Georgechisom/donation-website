 ...
 <form action="{{ route('send.message') }}" class="modalform" method="GET">
  ...
  <div class="why overflow-hidden">
    ...
    <div class="whyinded">
      <div class="why2" data-aos="fade-up">
        ...
        <p>
          We support diverse causes across the globe, touching lives in every corner of the world.
        </p>
      </div>
      <div class="why2" data-aos="fade-up">
        <i class="fa-solid fa-users fa-fade mb-3" style="margin-left: 45%; font-size:30px; font-weight:bold;"></i>
        <p class="globalreach">COMMUNITY IMPACT</p>
        <p> 
          Your donation strengthens communities, fosters education, provides healthcare, and empowers the underprivileged.
        </p>
      </div>
      <div class="why2" data-aos="fade-up">
        <i class="fa-solid fa-hands-holding fa-beat mb-3" style="margin-left: 45%; font-size:30px; font-weight:bold;"></i>
        <p class="globalreach">SUSTAINABLE CHANGE</p>
        <p> 
          We invest in sustainable projects, ensuring your donation creates a lasting impact for generations to come.
        </p>
      </div>
    </div>
  </div>
  ...
  <div class="bg-white overflow-hidden">
    <div class="wefirstneedyou"> 
      ...
      <div id="container" class="buttonexex" data-aos="zoom-in">
        <button class="buttonex learn-more">
          <span class="circle" aria-hidden="true">
            <a href="#" class="icon arrow mt-4"></a>
          </span>
          <a href="{{ route('donation.matters') }}" class="button-text text-decoration-none fw-bold">Learn More</a>
        </button>
      </div>
    </div>
  </div>
