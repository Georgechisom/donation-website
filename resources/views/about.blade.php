...
<div>
  <div class="ourmission">
    <div class="ourmission2">
      <span class="ourmissionspan" data-aos="fade-up"> Divineone Community </span>
      <strong class="ourmissionstrong" data-aos="fade-up">
        To transform aid and philanthropy to accelerate community-led change.
      </strong>
    </div>
    <div class="ourmission22">
      <span class="ourmissionspan2" data-aos="fade-up"> Divineone Community is a top-rated <br> charity </span>
      <div class="missionpicstogether">
        <img src="{{ asset('images/charityNavigator.png') }}" class="ourmissionpics" data-aos="fade-up"/>
        <img src="{{ asset('images/giveimage2.png') }}" class="ourmissionpics mt-3" data-aos="fade-up"/>
        <img src="{{ asset('images/candidplatinum.png') }}" class="ourmissionpics" data-aos="fade-up" />
      </div>
    </div>
  </div>
</div>
