...
<div class="bigshark ">
    <div class="">
        ...
        <p class="mt-3 weneedyousecond" data-aos="fade-up">
          We help companies to channel their massive support into charity <strong style="color: blue;"> child care</strong>, <strong style="color: blue;"> medical, health services,</strong> and <strong style="color: blue;"> also give to the </strong>.
        </p>
        ...
        <div class="partnergrid ">
            ...
            <img src="{{ asset("images/CompassionInternationalLogo.png") }}" alt="companye" class="partnerpics" data-aos="fade-up">
            <img src="{{ asset("images/CompaniesLogo1_21stCenturyFox.png") }}" alt="company" class="partnerpics" data-aos="fade-up">

            <img src="{{ asset("images/habitat.png") }}" alt="company" class="partnerpics" data-aos="fade-up">
            <img src="{{ asset("images/eesecondcompany.png") }}" alt="company" class="partnerpics" data-aos="fade-up">
            <img src="{{ asset("images/DirectRelief.png") }}" alt="company" class="partnerpics" data-aos="fade-up">
            <img src="{{ asset("images/tthridcompany.png") }}" alt="companye" class="partnerpics" data-aos="fade-up">
            <img src="{{ asset("images/efirstcompany.png") }}" alt="company" class="partnerpics" data-aos="fade-up">

            <img src="{{ asset("images/redcross.png") }}" alt="company" class="partnerpics" data-aos="fade-up">
            <img src="{{ asset("images/oxfam.svg.png") }}" alt="company" class="partnerpics" data-aos="fade-up">
            <img src="{{ asset("images/tetecompany.png") }}" alt="company" class="partnerpics" data-aos="fade-up">
            <img src="{{ asset("images/good.webp") }}" alt="companye" class="partnerpics" data-aos="fade-up">
            <img src="{{ asset("images/goodwill.webp") }}" alt="company" class="partnerpics" data-aos="fade-up">

            <img src="{{ asset("images/ymca.webp") }}" alt="company" class="partnerpics" data-aos="fade-up">
            <img src="{{ asset("images/mount.webp") }}" alt="company" class="partnerpics" data-aos="fade-up">
            <img src="{{ asset("images/catholic.webp") }}" alt="company" class="partnerpics" data-aos="fade-up">
            <img src="{{ asset("images/world.webp") }}" alt="companye" class="partnerpics" data-aos="fade-up">
            <img src="{{ asset("images/salvation.webp") }}" alt="company" class="partnerpics" data-aos="fade-up">

            <img src="{{ asset("images/cru.webp") }}" alt="company" class="partnerpics mt-5" data-aos="fade-up">
            <img src="{{ asset("images/child.png") }}" alt="company" class="partnerpics mt-5" data-aos="fade-up">
            <img src="{{ asset("images/dana.png") }}" alt="company" class="partnerpics mt-5" data-aos="fade-up">
